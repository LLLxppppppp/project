...
public class button extends JButton {
    ...
    //默认颜色 两种渐变色
    private Color BUTTON_COLOR1 = new Color(163, 196, 225, 46);
    private Color BUTTON_COLOR2 = new Color(163, 196, 225);
    ...
    //按下按钮时字体的默认颜色
    private Color BUTTON_FOREGROUND_COLOR1 = new Color(65, 84, 108);
