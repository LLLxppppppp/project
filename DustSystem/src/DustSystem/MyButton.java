...
public class MyButton extends JButton {
    ...
    //默认颜色 两种渐变色
    private Color BUTTON_COLOR1 = new Color(184, 218, 235, 68);
    private Color BUTTON_COLOR2 = new Color(137, 170, 170, 192);
    ...
    //按下按钮时字体的默认颜色
    private Color BUTTON_FOREGROUND_COLOR1 = new Color(64, 80, 77, 210);
